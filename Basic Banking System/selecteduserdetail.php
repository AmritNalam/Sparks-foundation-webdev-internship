    ...
    if (($amount)<0)
   {
    ...
    // constraint to check zero values
         ...
         echo "</script>";
                ...
                $receiver = $sql2['name'];
                $dt = date('Y-m-d H:i:s');
                $sql = "INSERT INTO transaction(sno, sender, receiver, balance, datetime) VALUES ('$sno','$sender','$receiver','$amount','$dt')";
                $query=mysqli_query($conn,$sql);
...
<body style="background-color : #00008B ;">
    ...
    <footer class="text-center mt-5 py-2">
            <p>&copy 2021 <b>Nalam Sai Amrit</b> <br> Zombie Foundation</p>
    </footer>
